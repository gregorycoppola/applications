...
then next-token prediction admits a Bayes-net interpretation: each forward
pass can be modeled as marginal inference in a Bayesian network over
language concepts, with the model behaving as though it is learning a
structured probabilistic model of the world and performing inference in it.
...
Next-token prediction admits a Bayes-net interpretation & Mechanistic interpretation \\
